...
//Create a constraint requiring Category nodes to have unique pk properties
CREATE CONSTRAINT category_pk
FOR (category:Category) REQUIRE category.pk IS UNIQUE;